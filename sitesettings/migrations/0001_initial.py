    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setting_type', models.IntegerField(choices=[(1, 'Common'), (2, 'Response Header')], verbose_name='Setting Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.ForeignKey(help_text='What setting is this value for?', on_delete=django.db.models.deletion.CASCADE, to='sitesettings.sitesettingkeymodel', verbose_name='Site Setting Key Name')),
